...
namespace vMenuClient.menus
{
    public class TimeOptions
    {
        ...
        private void CreateMenu()
        {
            ...
            freezeTimeToggle = new MenuItem("冻结/解冻时间", "Enable or disable time freezing.");
            var earlymorning = new MenuItem("清晨", "Set the time to 06:00.")
            {
                Label = "06:00"
            };
            var morning = new MenuItem("早上", "Set the time to 09:00.")
            {
                Label = "09:00"
            };
            var noon = new MenuItem("中午", "Set the time to 12:00.")
            {
                Label = "12:00"
            };
            var earlyafternoon = new MenuItem("午后", "Set the time to 15:00.")
            {
                Label = "15:00"
            };
            var afternoon = new MenuItem("下午", "Set the time to 18:00.")
            {
                Label = "18:00"
            };
            var evening = new MenuItem("wanshang", "Set the time to 21:00.")
            {
                Label = "21:00"
            };
            var midnight = new MenuItem("午夜", "Set the time to 00:00.")
            {
                Label = "00:00"
            };
            var night = new MenuItem("凌晨", "Set the time to 03:00.")
            {
                Label = "03:00"
            };
            ...
            var manualHour = new MenuListItem("设置自定义时间", hours, 0);
