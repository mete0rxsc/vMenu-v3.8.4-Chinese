...
namespace vMenuClient.menus
{
    public class PlayerAppearance
    {
        ...
        private void CreateMenu()
        {
            ...
            savedPedsMenu = new Menu(Game.Player.Name, "保存Pets");
            pedCustomizationMenu = new Menu(Game.Player.Name, "自定义保存的Pets");
            pedCollectionsMenu = new Menu(Game.Player.Name, "Ped系列");
            pedCollectionsCustomizationMenu = new Menu(Game.Player.Name, "我在运行时得到更新");
            spawnPedsMenu = new Menu(Game.Player.Name, "Spawn Ped");
            addonPedsMenu = new Menu(Game.Player.Name, "Peds的附加组件");
